...
const Blog = () => {
  ...
  return (
    <>
      <section class="text-gray-600 body-font overflow-hidden dark:bg-white bg-gray-900">
        <div class="container px-5 py-24 mx-auto">
          <div class="-my-8 divide-y-2 divide-gray-100">
            <div class="py-8 flex flex-wrap md:flex-nowrap">
              <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                <span class="font-semibold title-font text-gray-100 dark:text-gray-800">CATEGORY</span>
                <span class="mt-1 text-gray-400 dark:text-gray-700 text-sm ">12 Jun 2019</span>
              </div>
